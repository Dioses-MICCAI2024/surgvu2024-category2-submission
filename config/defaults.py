...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "mvitv2", "videoswintransformer", "VideoTransformer", "ActionFormer", 'MMViT']
...
_C.TEMPORAL_MODULE.STEPFORMER_D_MODEL=512
_C.TEMPORAL_MODULE.STEPFORMER_CAT_DIM=512
_C.TEMPORAL_MODULE.STEPFORMER_INPUT_DIM = 2304
_C.TEMPORAL_MODULE.STEPFORMER_NUM_LAYERS = 4
_C.TEMPORAL_MODULE.STEPFORMER_NUM_HEADS = 8


_C.TEMPORAL_MODULE.INSFORMER_D_MODEL=512
_C.TEMPORAL_MODULE.INSFORMER_CAT_DIM=512
_C.TEMPORAL_MODULE.INSFORMER_INPUT_DIM = 2304
_C.TEMPORAL_MODULE.INSFORMER_NUM_LAYERS = 4
_C.TEMPORAL_MODULE.INSFORMER_NUM_HEADS = 8
